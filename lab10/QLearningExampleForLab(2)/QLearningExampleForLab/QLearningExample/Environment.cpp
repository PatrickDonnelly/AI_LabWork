...
float Environment::calculateReward(sf::Vector2i previousAgentCoords, int selectedAction, sf::Vector2i currentAgentCoords,Grid& grid) 
{
	float reward = 0.0f;
	...
	else if (grid.checkForObstacle(currentAgentCoords.x, currentAgentCoords.y))
	{
		reward = -10000;
	}
	else 
